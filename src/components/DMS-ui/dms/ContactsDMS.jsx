      ...
      {parent?.msc_curator_doctor ? (
        <article className="contacts">
          <div className="contacts-info">
            ...
            <div className="contact">
              ...
              <div className="phone">
                <a href="mailto:rosbankDMS@bestdoctor.ru">rosbankDMS@bestdoctor.ru</a>
              </div>
            </div>
            <div className="contact-txt">
            ...
            <div className="contact">
              ...
              <ul>
                <li>Организация высокотехнологичной медицинской помощи в сложных случаях</li>
                <li>Организация плановых госпитализаций, сложных консультаций</li>
                <li>Курирование застрахованного в стационаре, контроль лечения</li>
                <li>Разбор претензий, застрахованных по программе страхования</li>
              </ul>
            </div>
            <div className="contact-txt">
              <h4>По другим вопросам можно обращаться в Управление компенсаций и льгот</h4>
            </div>
            <div className="contact">
              <div className="phone">
        ...
        <article className="contacts">
          <div className="contacts-info">
            ...
            <div className="contact-txt">
              <h4>Круглосуточная линия дежурных врачей BestDoctor по телефону</h4>
            </div>
            <div className="contact">
