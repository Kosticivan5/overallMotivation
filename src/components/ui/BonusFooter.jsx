const BonusFooter = () => {
  return (
    <footer className="bonus-footer">
      ...
      <p>
        Премия рассчитывается и выплачивается на основании Положения о
        премировании работников ПАО РОСБАНК по результатам оценки и выполнения
        ключевых показателей эффективности (
        <a
          href="https://cm6.rosbank.rus.socgen/cmj-web/#content;id=rkks%255C044257D00002744FA%253A471383851208425743258A7E00426777%253Fprojection%255C2default;p=-598408609;first=true"
          target="_blank"
          rel="noopener noreferrer"
        >
          ссылка
